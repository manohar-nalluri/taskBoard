...
const login = () => {
  ...
  return (
    <div className='border-2  border-black p-4 w-1/3 max-w-sm flex flex-col '>
      ...
      <p className="flex text-sm font-light text-gray-500 ">Don't have an account? <div onClick={()=>navigate('/signup')} className="font-medium text-primary-600 hover:underline ">Signup here</div></p>

...
const Signup = () => {
  ...
  return (
    ...
    <div className='border-2  border-black p-4 w-1/3 max-w-sm flex flex-col '>
      ...
      <p className="flex my-2 text-sm font-light text-gray-500 ">Already have an account? <p onClick={()=>navigator('/login')} className="font-medium text-primary-600 hover:underline hover:cursor-pointer">Login here</p></p>
    </div>
    </div>
  )
}
